...
func (ec *executionContext) field_Mutation_createCategory_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalONewCategory2ᚖgraphQLᚑgoᚋgraphᚋmodelᚐNewCategory(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) unmarshalONewCategory2ᚖgraphQLᚑgoᚋgraphᚋmodelᚐNewCategory(ctx context.Context, v interface{}) (*model.NewCategory, error) {
	if v == nil {
		return nil, nil
	}
